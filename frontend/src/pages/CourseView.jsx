...
const CourseView = () => {
    ...
    // courseId from query param (?courseId=...) for teacher-course routes
    const courseId = new URLSearchParams(location.search).get('courseId') || null;
    const isAiPath = location.pathname.startsWith('/ai-course');
            ...
            <div className={`flex-1 overflow-y-auto p-8 scrollbar-thin scrollbar-thumb-gray-700 max-w-5xl mx-auto w-full transition ${quizOpen ? 'blur-sm pointer-events-none' : ''}`}>
                ...
                <div className="mb-8">
                    <TutorPromptInput
                        ...
                        topicId={topicId}
                        moduleId={moduleId}
                        courseId={isAiPath ? null : courseId}
                        pathId={null}
