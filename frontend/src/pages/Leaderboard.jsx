...
const Leaderboard = () => {
    ...
    return (
        <div className="flex flex-col h-full w-full overflow-hidden bg-gray-900 text-gray-100 font-sans">
            <div className="bg-gray-900/90 backdrop-blur-md border-b border-gray-800 p-6 flex items-center shrink-0 z-50">
            ...
            <div className="flex-1 overflow-y-auto p-6 md:p-12 scrollbar-thin scrollbar-thumb-gray-700 w-full mb-8">
